        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative animate-fade-in-delayed">
              ...
              {/* Decorative quotes */}
              <div className="absolute -top-6 -left-6 w-12 h-12 bg-ume-purple rounded-full flex items-center justify-center text-white text-2xl font-serif">
                "
              </div>
              <div className="absolute -bottom-6 -right-6 w-12 h-12 bg-ume-pink rounded-full flex items-center justify-center text-white text-2xl font-serif rotate-180">
                "
              </div>
            </div>
          </div>
