...
const CaseStudy: React.FC = () => {
  ...
  return (
    <section className="py-16 bg-gradient-to-b from-ume-pink/3 to-white relative">
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto glass-card p-8 transition-all hover:shadow-md transform hover:-translate-y-1">
          ...
          <div className="text-gray-600 text-lg italic">
            "I texted 'You free tonight?' and got 'Maybe.' I was about to give
            up, but Ume told me she was playing coy and suggested 'Only if you
            say yes first.' She laughed and said yes! We've been dating for 2
            months now."
          </div>
