...
const FeatureHighlights: React.FC = () => {
  ...
  return (
    <section className="py-20 bg-gradient-to-r from-ume-purple/5 to-ume-pink/5 relative">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
          {features.map((feature, index) => (
            <div key={index} className="glass-card p-6 hover:shadow-md transition-all transform hover:-translate-y-1">
