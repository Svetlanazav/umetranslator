...
const blogPostsData = {
  "how-to-flirt-over-text": {
    ...
    content: `
      ...
      <img src="/blog-texting.webp" alt="Person texting on a smartphone" class="my-8 rounded-lg w-full" />
      ...
      <img src="/blog-couple.webp" alt="Happy couple looking at smartphone together" class="my-8 rounded-lg w-full" />
  ...
  "what-does-she-mean-by-im-fine": {
    ...
    content: `
      ...
      <img src="/blog-thinking.webp" alt="Woman looking thoughtful" class="my-8 rounded-lg w-full" />
      ...
      <img src="/blog-couple-talking.webp" alt="Couple having a serious conversation" class="my-8 rounded-lg w-full" />
  ...
  "how-to-keep-him-interested-texting": {
    ...
    category: "Dating",
    readTime: "7 min read",
    featuredImage: "/blog-interested.webp",
    content: `
      ...
      <img src="/blog-phone.webp" alt="Person holding smartphone" class="my-8 rounded-lg w-full" />
      ...
      <img src="/blog-happy.webp" alt="Person smiling at phone message" class="my-8 rounded-lg w-full" />
